...
export const hotel = { name: 'Hotel Plaza San Gaban', location: 'San Gabán, Puno, Perú', socials: { facebook: '', instagram: '' }, hero, room }
export const heroSlides = [hero, mistyForest, riverForest]
export const rooms = [
  { name:'Habitación Simple', description:'Un espacio sereno para descansar a tu ritmo.', image:room, features:['1 cama','Baño privado','TV','WiFi','Agua caliente'] },
  { name:'Habitación Matrimonial', description:'Calidez y comodidad para compartir el viaje.', image:'https://images.unsplash.com/photo-1590490360182-c33d57733427?auto=format&fit=crop&w=1000&q=85', features:['Cama matrimonial','Baño privado','TV','WiFi','Agua caliente'] },
  { name:'Habitación Doble', description:'La elección ideal para amigos o familia.', image:'https://images.unsplash.com/photo-1631049307264-da0ec9d70304?auto=format&fit=crop&w=1000&q=85', features:['2 camas','Baño privado','TV','WiFi','Agua caliente'] }
]
